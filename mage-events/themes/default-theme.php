...
<style>
    ...
    h3.ex-sec-title,
    #mep_event_ticket_type_table thead th {
...
<div class="mep-default-theme mep_flex default_theme">
    ...
    <?php } ?> 
        <div class="df-sidebar-part">
            <?php if ($hide_total_seat_details == 'no' && !$external_event) { ?>
