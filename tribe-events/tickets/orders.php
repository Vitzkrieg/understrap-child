...
<div id="tribe-events-content" class="tribe-events-single">
	...
	<?php if ( $is_event_page ) : ?>
		...
		<div class="tribe-events-schedule tribe-clearfix">
			<?php echo tribe_events_event_schedule_details( $event_id, '<h2 class="tribe-events-schedule__datetime">', '</h2>' ); ?>
		</div>
		<?php if ( $cost ) : ?>
		<div class="tribe-block tribe-block__event-price">
			<span class="tribe-block__event-price__title"> Cost: </span><span class="tribe-events-cost tribe-block__event-price__cost"><?php echo tribe_get_cost( null, true ) ?></span>
